...
export default class THREEHelper {
    ...
    initCamera(x, y, z) {
        this.cameras = new Cameras(x, y, z);
    ...
    initRenderer() {
        ...
        this.renderer.toneMappingExposure = 1.5; // 曝光度
    ...
    initControl() {
        const controls = new Controls(this.camera, this.renderer);
